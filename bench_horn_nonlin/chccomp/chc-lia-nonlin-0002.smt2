...
(assert (forall ((x0 Int) (x1 Int)) (=> (and (P0 x1) (g x1) (= x1 (+ 1 x0))) (P0 x0))))
					;(assert (forall ((x1 Int) (x0 Int) (x2 Int) (x3 Int)) (=> (and (P0 x1) (P1 x2 x3) (or (< x1 0) (> x1 0)) (= x1 (+ 1 x2)) (= x0 (+ 1 x3))) (P1 x1 x0))))
(assert (forall ((x1 Int) (x0 Int) (x2 Int) (x3 Int)) (=> (and (P0 x1) (P1 x2 x3) (g x1) (= x1 (+ 1 x2)) (= x0 (+ 1 x3))) (P1 x1 x0))))
